...
export class Pac {
    ...
    public imageUrl = 'assets/img/game/sb-icon.svg';
    public size = 0;
    public x = 0;
    public y = 0;
    public toX = this.x;
    ...
    constructor(game: Game) {
        ...
        this.capImage.LEFT.img.src = 'assets/img/game/cap.svg#left';
        this.capImage.RIGHT.img.src = 'assets/img/game/cap.svg#right';
        this.capImage.UP.img.src = 'assets/img/game/cap.svg#up';
        this.capImage.DOWN.img.src = 'assets/img/game/cap.svg#down';
    }
